...
const GetTouch = () => {
  return (
    <div className="bg-[#071125] w-full h-full lg:pb-[148px] pb-[70px]">
      <div className=" w-full h-full text-center text-white relative lg:pt-[250px] pt-[70px]">
            ...
            >
              ...
              <div className="md:px-8 px-4">
                ...
                <p className="text-[15px] md:text-[16px] md:leading-[24.64px] font-normal text-white mt-4 max-w-[917px] mx-auto">
                  ...
                  Whether you have questions about our AI-powered practice
                  exams, educational games, or want to learn more about
                  PrepCraft, feel free to contact us.
                </p>
                <div className="mt-[51px] flex flex-wrap items-center justify-center gap-4">
                  <button className="border-[1.5px] border-[#3B6EFF] md:w-[175px] md:h-[56px] h-[47px] px-4 rounded-[18px] text-white text-[16px] leading-[24px] font-semibold tracking-[-0.03em]">
                    Contact Us!
                  </button>
                  <button
                    style={{
                    ...
                    className="md:w-[178px] md:h-[56px] h-[47px] rounded-[18px] text-white text-[16px] px-4 leading-[24px] font-semibold tracking-[-0.03em]"
                  >
                    Start Free Trial
                  </button>
                </div>
