...
const Navbar = () => {
  ...
  return (
    <div className="md:px-8 px-4 relative z-[30]">
      ...
      >
        <div
          id="drawer-menu"
          className={`fixed right-0 top-0 h-full w-3/4 max-w-[300px] bg-[#071125] p-6 text-white transition-transform duration-300 ${
